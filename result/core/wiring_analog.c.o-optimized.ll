; ModuleID = '/home/aaa/llvm-arduino-due/build/core/wiring_analog.c.o.ll'
...
dec_start:                                        ; preds = %entry
  ...
  store i8* blockaddress(@analogReadResolution, %entry.RetBlock), i8** %ptr, align 4
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@analogWriteResolution, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@analogReference, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %sw.epilog
  ...
  store i8* blockaddress(@analogRead, %sw.epilog.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond

dec_cond:                                         ; preds = %dec_add, %dec_start
  %19 = load i32, i32* %i, align 4
  %cmp3 = icmp slt i32 %19, 12
  br i1 %cmp3, label %dec_ing, label %dec_end

dec_ing:                                          ; preds = %dec_cond
  %20 = load i32, i32* %i, align 4
  %21 = load i8*, i8** %ptr, align 4
  %arrayidx14 = getelementptr inbounds i8, i8* %21, i32 %20
  %22 = load i8, i8* %arrayidx14, align 1
  %23 = load i32, i32* %i, align 4
  %arrayidx25 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %23
...
dec_jmp:                                          ; preds = %dec_end
  ...
  indirectbr i8* %29, [label %sw.epilog.RetBlock]
...
dec_start:                                        ; preds = %return
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@mapResolution, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@analogOutputInit, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
if.end129:                                        ; preds = %if.else128, %if.then127, %if.end122, %if.end62, %while.end
  br label %dec_start

dec_start:                                        ; preds = %if.end129
  %arrayidx2 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx2, i8** %ptr2, align 4
  store i8* blockaddress(@analogWrite, %if.end129.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond

dec_cond:                                         ; preds = %dec_add, %dec_start
  %104 = load i32, i32* %i, align 4
  %cmp3 = icmp slt i32 %104, 12
  br i1 %cmp3, label %dec_ing, label %dec_end

dec_ing:                                          ; preds = %dec_cond
  %105 = load i32, i32* %i, align 4
  %106 = load i8*, i8** %ptr, align 4
  %arrayidx14 = getelementptr inbounds i8, i8* %106, i32 %105
  %107 = load i8, i8* %arrayidx14, align 1
  %108 = load i32, i32* %i, align 4
  %arrayidx25 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %108
  store i8 %107, i8* %arrayidx25, align 1
  %109 = load i32, i32* %i, align 4
  %arrayidx3 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %109
  %110 = load i8, i8* %arrayidx3, align 1
  %conv6 = zext i8 %110 to i32
  %xor = xor i32 %conv6, 133
  %conv47 = trunc i32 %xor to i8
  %111 = load i32, i32* %i, align 4
  %arrayidx5 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %111
...
dec_end:                                          ; preds = %dec_cond
  %114 = load i8*, i8** %ptr2, align 4
  br label %dec_jmp

dec_jmp:                                          ; preds = %dec_end
  %115 = phi i8* [ %114, %dec_end ]
  indirectbr i8* %114, [label %if.end129.RetBlock]

if.end129.RetBlock:                               ; preds = %dec_jmp
  ret void, !dbg !739
}
...
dec_start:                                        ; preds = %entry
  ...
  store i8* blockaddress(@TC_SetCMR_ChannelA, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_ing:                                          ; preds = %dec_cond
  ...
  %arrayidx23 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %10
...
dec_start:                                        ; preds = %entry
  %arrayidx1 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx1, i8** %ptr2, align 4
  store i8* blockaddress(@TC_SetCMR_ChannelB, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
