; ModuleID = '/home/aaa/llvm-arduino-due/build/core/new.cpp.o.ll'
...
dec_start:                                        ; preds = %entry
  ...
  store i8* blockaddress(@_Znwj, %entry.RetBlock), i8** %ptr, align 4
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_Znaj, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZdlPv, %entry.RetBlock), i8** %ptr1, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZdaPv, %entry.RetBlock), i8** %ptr1, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
