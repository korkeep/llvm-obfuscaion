; ModuleID = '/home/aaa/llvm-arduino-due/build/core/Stream.cpp.o.ll'
...
dec_start:                                        ; preds = %return
  ...
  store i8* blockaddress(@_ZN6Stream9timedReadEv, %return.RetBlock), i8** %ptr, align 4
...
dec_start:                                        ; preds = %return
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream9timedPeekEv, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
while.body:                                       ; preds = %sw.epilog12, %entry
...
sw.bb11:                                          ; preds = %sw.epilog, %if.end
  br label %sw.epilog12, !dbg !130

sw.epilog12:                                      ; preds = %sw.bb11, %if.end
...
dec_start:                                        ; preds = %return
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream13peekNextDigitE13LookaheadModeb, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond

dec_cond:                                         ; preds = %dec_add, %dec_start
  %12 = load i32, i32* %i, align 4
  %cmp1 = icmp slt i32 %12, 12
  br i1 %cmp1, label %dec_ing, label %dec_end
...
dec_jmp:                                          ; preds = %dec_end
  ...
  indirectbr i8* %22, [label %return.RetBlock]
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream10setTimeoutEm, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream4findEPc, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %return
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream9findUntilEPcjS0_j, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream4findEPcj, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream9findUntilEPcS0_, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
while.body:                                       ; preds = %for.end67, %for.end
...
dec_start:                                        ; preds = %return
  ...
  store i8* blockaddress(@_ZN6Stream9findMultiEPNS_11MultiTargetEi, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i1, align 4
  br label %dec_cond

dec_cond:                                         ; preds = %dec_add, %dec_start
  %67 = load i32, i32* %i1, align 4
  %cmp4 = icmp slt i32 %67, 12
  br i1 %cmp4, label %dec_ing, label %dec_end

dec_ing:                                          ; preds = %dec_cond
  %68 = load i32, i32* %i1, align 4
  %69 = load i8*, i8** %ptr, align 4
  %arrayidx1 = getelementptr inbounds i8, i8* %69, i32 %68
  %70 = load i8, i8* %arrayidx1, align 1
  %71 = load i32, i32* %i1, align 4
  %arrayidx25 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %71
  store i8 %70, i8* %arrayidx25, align 1
  %72 = load i32, i32* %i1, align 4
  %arrayidx3 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %72
  %73 = load i8, i8* %arrayidx3, align 1
  %conv6 = zext i8 %73 to i32
  %xor = xor i32 %conv6, 133
  %conv4 = trunc i32 %xor to i8
  %74 = load i32, i32* %i1, align 4
  %arrayidx5 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %74
  store i8 %conv4, i8* %arrayidx5, align 1
  br label %dec_add
...
dec_jmp:                                          ; preds = %dec_end
  %78 = phi i8* [ %77, %dec_end ]
  indirectbr i8* %77, [label %return.RetBlock]
...
dec_start:                                        ; preds = %return
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream8parseIntE13LookaheadModec, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_ing:                                          ; preds = %dec_cond
  ...
  %arrayidx1 = getelementptr inbounds i8, i8* %22, i32 %21
...
dec_start:                                        ; preds = %return
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream10parseFloatE13LookaheadModec, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond

dec_cond:                                         ; preds = %dec_add, %dec_start
  %28 = load i32, i32* %i, align 4
  %cmp1 = icmp slt i32 %28, 12
  br i1 %cmp1, label %dec_ing, label %dec_end

dec_ing:                                          ; preds = %dec_cond
  %29 = load i32, i32* %i, align 4
  %30 = load i8*, i8** %ptr, align 4
  %arrayidx1 = getelementptr inbounds i8, i8* %30, i32 %29
  %31 = load i8, i8* %arrayidx1, align 1
  %32 = load i32, i32* %i, align 4
  %arrayidx2 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %32
  store i8 %31, i8* %arrayidx2, align 1
  %33 = load i32, i32* %i, align 4
  %arrayidx3 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %33
  %34 = load i8, i8* %arrayidx3, align 1
  %conv2 = zext i8 %34 to i32
  %xor = xor i32 %conv2, 133
  %conv4 = trunc i32 %xor to i8
  %35 = load i32, i32* %i, align 4
  %arrayidx5 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %35
  store i8 %conv4, i8* %arrayidx5, align 1
  br label %dec_add
...
dec_jmp:                                          ; preds = %dec_end
  %39 = phi i8* [ %38, %dec_end ]
  indirectbr i8* %38, [label %return.RetBlock]
...
dec_start:                                        ; preds = %while.end
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream9readBytesEPcj, %while.end.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %return
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream14readBytesUntilEcPcj, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %nrvo.skipdtor
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream10readStringEv, %nrvo.skipdtor.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_jmp:                                          ; preds = %dec_end
  ...
  indirectbr i8* %13, [label %nrvo.skipdtor.RetBlock]
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6StringpLEc, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %nrvo.skipdtor
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN6Stream15readStringUntilEc, %nrvo.skipdtor.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_jmp:                                          ; preds = %dec_end
  ...
  indirectbr i8* %16, [label %nrvo.skipdtor.RetBlock]
...
!2 = !{!3}
!3 = distinct !DICompositeType(tag: DW_TAG_enumeration_type, name: "LookaheadMode", file: !4, line: 41, baseType: !5, size: 8, elements: !6, identifier: "_ZTS13LookaheadMode")
...
!19 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "Stream", file: !4, line: 49, flags: DIFlagFwdDecl, identifier: "_ZTS6Stream")
...
!717 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "__FlashStringHelper", file: !694, line: 37, flags: DIFlagFwdDecl, identifier: "_ZTS19__FlashStringHelper")
...
!726 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "StringSumHelper", file: !694, line: 213, flags: DIFlagFwdDecl, identifier: "_ZTS15StringSumHelper")
