; ModuleID = '/home/aaa/llvm-arduino-due/build/core/wiring_pulse.cpp.o.ll'
...
dec_start:                                        ; preds = %return
  ...
  store i8* blockaddress(@pulseIn, %return.RetBlock), i8** %ptr, align 4
...
dec_ing:                                          ; preds = %dec_cond
  ...
  %arrayidx12 = getelementptr inbounds i8, i8* %18, i32 %17
...
dec_start:                                        ; preds = %return
  %arrayidx1 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx1, i8** %ptr2, align 4
  store i8* blockaddress(@pulseInLong, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond

dec_cond:                                         ; preds = %dec_add, %dec_start
  %26 = load i32, i32* %i, align 4
  %cmp3 = icmp slt i32 %26, 12
  br i1 %cmp3, label %dec_ing, label %dec_end

dec_ing:                                          ; preds = %dec_cond
  %27 = load i32, i32* %i, align 4
  %28 = load i8*, i8** %ptr, align 4
  %arrayidx14 = getelementptr inbounds i8, i8* %28, i32 %27
  %29 = load i8, i8* %arrayidx14, align 1
  %30 = load i32, i32* %i, align 4
  %arrayidx2 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %30
  store i8 %29, i8* %arrayidx2, align 1
  %31 = load i32, i32* %i, align 4
  %arrayidx3 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %31
  %32 = load i8, i8* %arrayidx3, align 1
  %conv = zext i8 %32 to i32
  %xor = xor i32 %conv, 133
  %conv4 = trunc i32 %xor to i8
  %33 = load i32, i32* %i, align 4
  %arrayidx5 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %33
  store i8 %conv4, i8* %arrayidx5, align 1
  br label %dec_add
...
dec_jmp:                                          ; preds = %dec_end
  %37 = phi i8* [ %36, %dec_end ]
  indirectbr i8* %36, [label %return.RetBlock]
...
!2 = !{!3, !13, !36, !47}
!3 = distinct !DICompositeType(tag: DW_TAG_enumeration_type, name: "_EPioType", file: !4, line: 44, baseType: !5, size: 8, elements: !6, identifier: "_ZTS9_EPioType")
...
!13 = distinct !DICompositeType(tag: DW_TAG_enumeration_type, name: "_EAnalogChannel", file: !14, line: 86, baseType: !15, size: 8, elements: !16, identifier: "_ZTS15_EAnalogChannel")
...
!36 = distinct !DICompositeType(tag: DW_TAG_enumeration_type, name: "_EPWMChannel", file: !14, line: 112, baseType: !15, size: 8, elements: !37, identifier: "_ZTS12_EPWMChannel")
...
!47 = distinct !DICompositeType(tag: DW_TAG_enumeration_type, name: "_ETCChannel", file: !14, line: 126, baseType: !15, size: 8, elements: !48, identifier: "_ZTS11_ETCChannel")
