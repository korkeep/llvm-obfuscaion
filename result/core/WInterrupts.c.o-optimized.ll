; ModuleID = '/home/aaa/llvm-arduino-due/build/core/WInterrupts.c.o.ll'
...
dec_jmp:                                          ; preds = %dec_end
  %59 = phi i8* [ %58, %dec_end ]
  indirectbr i8* %58, [label %if.end36.RetBlock]

if.end36.RetBlock:                                ; preds = %dec_jmp
  ret void, !dbg !385
}
...
dec_start:                                        ; preds = %entry
  %arrayidx2 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx2, i8** %ptr2, align 4
  store i8* blockaddress(@detachInterrupt, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %while.end
  ...
  store i8* blockaddress(@PIOA_Handler, %while.end.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_jmp:                                          ; preds = %dec_end
  ...
  indirectbr i8* %22, [label %while.end.RetBlock]
...
dec_start:                                        ; preds = %while.end
  %arrayidx1 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx1, i8** %ptr2, align 4
  store i8* blockaddress(@PIOB_Handler, %while.end.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %while.end
  %arrayidx1 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx1, i8** %ptr2, align 4
  store i8* blockaddress(@PIOC_Handler, %while.end.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %while.end
  %arrayidx1 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx1, i8** %ptr2, align 4
  store i8* blockaddress(@PIOD_Handler, %while.end.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %for.end
  %arrayidx4 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx4, i8** %ptr2, align 4
  store i8* blockaddress(@__initialize, %for.end.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i1, align 4
  br label %dec_cond

dec_cond:                                         ; preds = %dec_add, %dec_start
  %6 = load i32, i32* %i1, align 4
  %cmp5 = icmp slt i32 %6, 12
  br i1 %cmp5, label %dec_ing, label %dec_end

dec_ing:                                          ; preds = %dec_cond
  %7 = load i32, i32* %i1, align 4
  %8 = load i8*, i8** %ptr, align 4
  %arrayidx16 = getelementptr inbounds i8, i8* %8, i32 %7
  %9 = load i8, i8* %arrayidx16, align 1
  %10 = load i32, i32* %i1, align 4
  %arrayidx27 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %10
  store i8 %9, i8* %arrayidx27, align 1
  %11 = load i32, i32* %i1, align 4
  %arrayidx38 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %11
...
dec_jmp:                                          ; preds = %dec_end
  %17 = phi i8* [ %16, %dec_end ]
  indirectbr i8* %16, [label %for.end.RetBlock]
...
dec_start:                                        ; preds = %entry
  %arrayidx1 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx1, i8** %ptr2, align 4
  store i8* blockaddress(@NVIC_DisableIRQ, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %entry
  %arrayidx1 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx1, i8** %ptr2, align 4
  store i8* blockaddress(@NVIC_ClearPendingIRQ, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %if.end
  %arrayidx1 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx1, i8** %ptr2, align 4
  store i8* blockaddress(@NVIC_SetPriority, %if.end.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %entry
  %arrayidx1 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx1, i8** %ptr2, align 4
  store i8* blockaddress(@NVIC_EnableIRQ, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
