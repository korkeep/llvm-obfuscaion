; ModuleID = '/home/aaa/.arduino15/packages/arduino/hardware/sam/1.6.12/cores/arduino/WString.cpp'
...
if.end78:                                         ; preds = %if.then, %if.then44, %if.then48, %if.end77, %while.end
  ret void, !dbg !2090
}
...
!33 = !DICompositeType(tag: DW_TAG_class_type, name: "__FlashStringHelper", file: !5, line: 37, flags: DIFlagFwdDecl, identifier: "_ZTS19__FlashStringHelper")
