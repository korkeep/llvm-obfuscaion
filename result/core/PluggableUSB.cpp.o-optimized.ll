; ModuleID = '/home/aaa/llvm-arduino-due/build/core/PluggableUSB.cpp.o.ll'
...
dec_start:                                        ; preds = %return
  ...
  store i8* blockaddress(@_ZN13PluggableUSB_12getInterfaceEPh, %return.RetBlock), i8** %ptr, align 4
...
dec_start:                                        ; preds = %return
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN13PluggableUSB_13getDescriptorER8USBSetup, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %for.end
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN13PluggableUSB_12getShortNameEPc, %for.end.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %return
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN13PluggableUSB_5setupER8USBSetup, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %return
  ...
  store i8* blockaddress(@_ZN13PluggableUSB_4plugEP18PluggableUSBModule, %return.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i1, align 4
  br label %dec_cond

dec_cond:                                         ; preds = %dec_add, %dec_start
  %30 = load i32, i32* %i1, align 4
  %cmp3 = icmp slt i32 %30, 12
  br i1 %cmp3, label %dec_ing, label %dec_end

dec_ing:                                          ; preds = %dec_cond
  %31 = load i32, i32* %i1, align 4
  %32 = load i8*, i8** %ptr, align 4
  %arrayidx1 = getelementptr inbounds i8, i8* %32, i32 %31
  %33 = load i8, i8* %arrayidx1, align 1
  %34 = load i32, i32* %i1, align 4
  %arrayidx24 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %34
  store i8 %33, i8* %arrayidx24, align 1
  %35 = load i32, i32* %i1, align 4
  %arrayidx3 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %35
  %36 = load i8, i8* %arrayidx3, align 1
  %conv5 = zext i8 %36 to i32
  %xor = xor i32 %conv5, 133
  %conv4 = trunc i32 %xor to i8
  %37 = load i32, i32* %i1, align 4
  %arrayidx5 = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 %37
  store i8 %conv4, i8* %arrayidx5, align 1
  br label %dec_add
...
dec_end:                                          ; preds = %dec_cond
  %40 = load i8*, i8** %ptr2, align 4
  br label %dec_jmp

dec_jmp:                                          ; preds = %dec_end
  %41 = phi i8* [ %40, %dec_end ]
  indirectbr i8* %40, [label %return.RetBlock]
...
dec_start:                                        ; preds = %init.end
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_Z12PluggableUSBv, %init.end.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_jmp:                                          ; preds = %dec_end
  ...
  indirectbr i8* %11, [label %init.end.RetBlock]

init.end.RetBlock:                                ; preds = %dec_jmp
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@_ZN13PluggableUSB_C2Ev, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
!19 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "PluggableUSBModule", file: !8, line: 27, flags: DIFlagFwdDecl, identifier: "_ZTS18PluggableUSBModule")
...
!39 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !38, line: 112, flags: DIFlagFwdDecl, identifier: "_ZTS8USBSetup")
