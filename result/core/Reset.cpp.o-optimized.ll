; ModuleID = '/home/aaa/llvm-arduino-due/build/core/Reset.cpp.o.ll'
...
while.body7:                                      ; preds = %while.body7, %while.end5
...
dec_start:                                        ; preds = %entry
  ...
  store i8* blockaddress(@initiateReset, %entry.RetBlock), i8** %ptr, align 4
...
dec_start:                                        ; preds = %entry
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@cancelReset, %entry.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond
...
dec_start:                                        ; preds = %if.end3
  %arrayidx = getelementptr inbounds [12 x i8], [12 x i8]* %ret_ptr, i32 0, i32 0
  store i8* %arrayidx, i8** %ptr2, align 4
  store i8* blockaddress(@tickReset, %if.end3.RetBlock), i8** %ptr, align 4
  store i32 0, i32* %i, align 4
  br label %dec_cond

dec_cond:                                         ; preds = %dec_add, %dec_start
  %3 = load i32, i32* %i, align 4
  %cmp2 = icmp slt i32 %3, 12
...
dec_jmp:                                          ; preds = %dec_end
  ...
  indirectbr i8* %13, [label %if.end3.RetBlock]
