; ModuleID = '/home/aaa/.arduino15/packages/arduino/hardware/sam/1.6.12/cores/arduino/wiring_digital.c'
...
sw.epilog:                                        ; preds = %if.then, %if.then44, %sw.default, %if.end97, %sw.bb57, %sw.bb
  ret void, !dbg !232
}
...
if.end27:                                         ; preds = %if.then, %if.else, %if.then18
  ret void, !dbg !295
}
